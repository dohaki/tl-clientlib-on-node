...
export declare type AnyNetworkEvent = NetworkTransferEvent | NetworkTrustlineEvent;
export declare type AnyNetworkEventRaw = NetworkTransferEventRaw | NetworkTrustlineEventRaw;
...
export declare type CloseTxObject = PaymentTxObject;
