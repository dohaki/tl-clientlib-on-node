...
var RelayProvider = /** @class */ (function () {
    ...
    RelayProvider.prototype.fetchEndpoint = function (endpoint, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, utils_1.default.fetchUrl(this.relayApiUrl + "/" + trimmedEndpoint, options)];
            });
        });
    };
    /**
     ...
     */
    RelayProvider.prototype.createWebsocketStream = function (endpoint, functionName, args) {
        var trimmedEndpoint = utils_1.default.trimUrl(endpoint);
        return utils_1.default.websocketStream(this.relayWsApiUrl + "/" + trimmedEndpoint, functionName, args);
    };
    /**
    ...
    RelayProvider.prototype.getTxInfos = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.fetchEndpoint("users/" + address + "/txinfos")];
                    case 1:
                        _a = _b.sent(), nonce = _a.nonce, gasPrice = _a.gasPrice, balance = _a.balance;
                        return [2 /*return*/, {
    ...
    RelayProvider.prototype.getBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fetchEndpoint("users/" + address + "/balance")];
                    case 1:
                        balance = _a.sent();
    ...
    RelayProvider.prototype.sendSignedTransaction = function (signedTransaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.fetchEndpoint("relay", options)];
            });
        });
    };
